...
def index():
    ...
    if last_rate.buy_rate > previous_rate.buy_rate:
        buy_trend = "up"
    elif last_rate.buy_rate > previous_rate.buy_rate:
        buy_trend = "down"
    else:
        buy_trend = "nochange"

    if last_rate.sell_rate > previous_rate.sell_rate:
        sell_trend = "up"
    elif last_rate.sell_rate > previous_rate.sell_rate:
        sell_trend = "down"
    else:
        sell_trend = "nochange"
